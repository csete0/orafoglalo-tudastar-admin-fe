...
export class AdminCouponService {
   ...
   * §3 migráció: a diák-app nyilvános api/Payment/sub-types helyett a saját (Admin.API)
   * host-on át - admin-fe kizárólag az Admin.API-t hívja, nincs külön origin-függés.
   */
  subscriptionTypes(): Observable<SubscriptionTypeOption[]> {
    return this.http.get<SubscriptionTypeOption[]>(`${this.baseUrl}/subscription-types`);
  }
}
